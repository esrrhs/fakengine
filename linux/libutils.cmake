...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME STATIC_LIBS)
  ...
  MESSAGE("OSLIBS ${OSLIBS} TARGET ${TARGET} OUTPUT_NAME ${OUTPUT_NAME} CMAKE_CURRENT_BINARY_DIR ${CMAKE_CURRENT_BINARY_DIR} STATIC_LIBS ${STATIC_LIBS} CMAKE_COMMAND ${CMAKE_COMMAND}")
