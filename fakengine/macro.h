...
#define SAFE_TEST_INDEX(EXPRESSION, TESTVALUE) if(((int64_t)(EXPRESSION)) < 0 || ((uint64_t)(EXPRESSION)) >= ((uint64_t)(TESTVALUE))) return;
#define SAFE_TEST_INDEX_VAL(EXPRESSION, TESTVALUE, RETURNVALUE) if(((int64_t)(EXPRESSION)) < 0 || ((uint64_t)(EXPRESSION)) >= ((uint64_t)(TESTVALUE))) return RETURNVALUE;
